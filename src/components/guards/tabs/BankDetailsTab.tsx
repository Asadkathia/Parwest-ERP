            ...
            <div className="bg-white rounded-lg border p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p className="font-medium text-lg font-mono">{bankDetails.accountNumber || "—"}</p>
                    </div>
                    <div>
                    ...
                    <div className="md:col-span-2">
                        ...
                        <p className="font-medium text-lg font-mono">{bankDetails.iban || "—"}</p>
                    </div>
                    <div>
                        <p className="text-sm text-gray-600">Card Status</p>
                        <span className={`inline-block px-3 py-1 rounded-full text-sm font-medium ${bankDetails.cardStatus === "ACTIVE"
                                ? "bg-green-100 text-green-800"
                                : "bg-gray-100 text-gray-800"
                            }`}>
                            {bankDetails.cardStatus || "—"}
                        </span>
                    </div>
                </div>
            </div>

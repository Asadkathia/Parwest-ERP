...
export async function GET(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ message: "Failed to fetch special duty records." }, { status: 500 })
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ message: "Failed to save special duty." }, { status: 500 })
  }
}

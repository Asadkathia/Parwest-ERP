...
const directMap = new Map([
  ...
  ['/bulkImport/clients/addBranches', '/bulkImport/clients/addBranches'],
  ['/bulkImport/clients/addClients', '/bulkImport/clients/addClients'],
  ['/bulkImport/guards/addBankDetailsBulkImport', '/bulkImport/guards/addBankDetailsBulkImport'],
  ['/bulkImport/guards/addEmploymentHistoryBulkImport', '/bulkImport/guards/addEmploymentHistoryBulkImport'],
  ['/bulkImport/guards/addFamilyBulkImport', '/bulkImport/guards/addFamilyBulkImport'],
  ['/bulkImport/guards/addJudicialCasesBulkImport', '/bulkImport/guards/addJudicialCasesBulkImport'],
  ['/bulkImport/guards/addLoanDetailsBulkImport', '/bulkImport/guards/addLoanDetailsBulkImport'],
  ['/bulkImport/guards/addNearestRelativeBulkImport', '/bulkImport/guards/addNearestRelativeBulkImport'],
  ['/bulkImport/guards/addPledgedDocumentBulkImport', '/bulkImport/guards/addPledgedDocumentBulkImport'],
  ['/bulkImport/guards/addVerificationsBulkImport', '/bulkImport/guards/addVerificationsBulkImport'],
  ['/bulkImport/guards/markAttendanceBulkImport', '/bulkImport/guards/markAttendanceBulkImport'],
  ['/bulkImport/inventory/inventoryBulkAssignPage', '/bulkImport/inventory/inventoryBulkAssignPage'],
  ['/bulkImport/inventory/inventoryBulkImportPage', '/bulkImport/inventory/inventoryBulkImportPage'],
  ['/bulkImport/inventory/inventoryBulkUpdatePage', '/bulkImport/inventory/inventoryBulkUpdatePage'],
  ['/bulkImport/users/addUserBulkImport', '/bulkImport/users/addUserBulkImport'],
  ['/user/profile', '/user/profile'],
  ['/client/clientInsuranceSettings', '/client/clientInsuranceSettings'],
  ['/guard/mergedOptions', '/guard/mergedOptions'],
  ['/audit/auditSearch', '/audit/auditSearch'],
  ['/user/guardVerificationStatusesList', '/user/guardVerificationStatusesList'],
  ['/user/guardVerificationTypesList', '/user/guardVerificationTypesList'],
  ['/user/updateLogos', '/user/updateLogos'],
  ['/guard/onjob-training-intervals', '/guard/onjob-training-intervals'],
  ['/guard/status-update', '/guard/status-update'],
  ['/guard/acceptedRejectedByCol', '/guard/acceptedRejectedByCol'],
  ['/inventory/inventory-report', '/inventory/inventory-report'],
  ['/searchByDataTable', '/searchByDataTable'],
  ['/reports/scheduledreports', '/reports/scheduledreports'],
  ['/reports/guardDeploymentreports', '/reports/guardDeploymentreports'],
  ['/reports/dayNightDutyGuards', '/reports/dayNightDutyGuards'],
  ['/reports/clientEnrolledreports', '/reports/clientEnrolledreports'],
  ['/reports/client-summary', '/reports/client-summary'],
  ['/reports/client-branch-deactive-report', '/reports/client-branch-deactive-report'],
  ['/reports/dailyUserReport', '/reports/dailyUserReport'],
  ['/reports/dailydeploymentreport', '/reports/dailydeploymentreport'],
  ['/reports/finalized-paid-loan', '/reports/finalized-paid-loan'],
  ['/reports/guardEnrolledreports', '/reports/guardEnrolledreports'],
  ['/reports/guards', '/reports/guards'],
  ['/reports/managers-supervisors-guards', '/reports/managers-supervisors-guards'],
  ['/reports/shortdeployment', '/reports/shortdeployment'],
  ['/reports/unassignguards', '/reports/unassignguards'],
  ['/reports/clients/client-branch-increase-decrease-report', '/reports/clients/client-branch-increase-decrease-report'],
])
